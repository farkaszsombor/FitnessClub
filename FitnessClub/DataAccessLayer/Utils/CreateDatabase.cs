    ...
    public class CreateDatabase
    {
        public static void InitDatabase()
        {
            using (var ctx = new NorthwindContext())
            {
                ...
                Employee e1 = new Employee { Name = "Admin", Password = "1234", IsDeleted = boolean, Department = "Admin", WorkPlace = r, StartHour = 9, EndHour = 17, Days = "H_SZE_P_V" };
                Employee e2 = new Employee { Name = "herr54y", Password = "4411", IsDeleted = boolean, Department = "Trainer", WorkPlace = b, StartHour = 5, EndHour = 12, Days = "H_K_SZE_CS_P" };
                Employee e3 = new Employee { Name = "james42", Password = "12354", IsDeleted = boolean, Department = "Guest", WorkPlace = re, StartHour = 5, EndHour = 12, Days = "H_K_SZE_CS_P" };
                Employee e4 = new Employee { Name = "katy96", Password = "12734", IsDeleted = boolean, Department = "Worker", WorkPlace = p, StartHour = 3, EndHour = 13, Days = "H_CS_P" };
                Employee e5 = new Employee { Name = "adamkis", Password = "17234", IsDeleted = boolean, Department = "IT", WorkPlace = black, StartHour = 5, EndHour = 12, Days = "H_K_SZE_CS_P" };
                Employee e6 = new Employee { Name = "mark87", Password = "12347", IsDeleted = boolean, Department = "cleaner", WorkPlace = w, StartHour = 4, EndHour = 19, Days = "H_K_SZE" };
                Employee e7 = new Employee { Name = "peter45", Password = "158234", IsDeleted = boolean, Department = "Boss", WorkPlace = g, StartHour = 5, EndHour = 12, Days = "H_K_SZE_CS_P" };
                Employee e8 = new Employee { Name = "stean56", Password = "12834", IsDeleted = boolean, Department = "Trainer", WorkPlace = y, StartHour = 5, EndHour = 12, Days = "H_K_SZE_CS_P" };
                Employee e9 = new Employee { Name = "loise37", Password = "18234", IsDeleted = boolean, Department = "IT", WorkPlace = b, StartHour = 5, EndHour = 12, Days = "H_K_SZE_CS_P" };
                Employee e10 = new Employee { Name = "corina21", Password = "182234", IsDeleted = boolean, Department = "Admin", WorkPlace = re, StartHour = 5, EndHour = 12, Days = "H_K_SZE_CS_P" };
                Employee e11 = new Employee { Name = "helen57", Password = "182334", IsDeleted = boolean, Department = "Worker", WorkPlace = y, StartHour = 2, EndHour = 6, Days = "H_K_P" };
                Employee e12 = new Employee { Name = "annie68", Password = "1824534", IsDeleted = boolean, Department = "Student", WorkPlace = g, StartHour = 5, EndHour = 12, Days = "H_K_SZE_CS_P" };
                Employee e13 = new Employee { Name = "brian24", Password = "182834", IsDeleted = boolean, Department = "Student", WorkPlace = w, StartHour = 7, EndHour = 17, Days = "H_K_SZE_CS_P_SZO_V" };
                Employee e14 = new Employee { Name = "david34", Password = "186234", IsDeleted = boolean, Department = "Boss", WorkPlace = black, StartHour = 5, EndHour = 22, Days = "H_K" };
                Employee e15 = new Employee { Name = "stephen_hawking", Password = "186234", IsDeleted = boolean, Department = "IT", WorkPlace = b, StartHour = 12, EndHour = 19, Days = "H_K_P" };
