    ...
    public class CreateDatabase
    {
        public static void InitDatabase()
        {
            using (var ctx = new NorthwindContext())
            {
                ...
                Employee e2 = new Employee { Name = "herr54y", Password = "4411", IsDeleted = boolean, Department = "Trainer", WorkPlace = b, StartHour = 5, EndHour = 12, Days = "H_K_SZ_CS_P" };
                Employee e3 = new Employee { Name = "james42", Password = "12354", IsDeleted = boolean, Department = "Guest", WorkPlace = re, StartHour = 5, EndHour = 12, Days = "H_K_SZ_CS_P" };
                ...
                Employee e5 = new Employee { Name = "adamkis", Password = "17234", IsDeleted = boolean, Department = "IT", WorkPlace = black, StartHour = 5, EndHour = 12, Days = "H_K_SZ_CS_P" };
                Employee e6 = new Employee { Name = "mark87", Password = "12347", IsDeleted = boolean, Department = "cleaner", WorkPlace = w, StartHour = 4, EndHour = 19, Days = "H_K_SZ" };
                Employee e7 = new Employee { Name = "peter45", Password = "158234", IsDeleted = boolean, Department = "Boss", WorkPlace = g, StartHour = 5, EndHour = 12, Days = "H_K_SZ_CS_P" };
                Employee e8 = new Employee { Name = "stean56", Password = "12834", IsDeleted = boolean, Department = "Trainer", WorkPlace = y, StartHour = 5, EndHour = 12, Days = "H_K_SZ_CS_P" };
                Employee e9 = new Employee { Name = "loise37", Password = "18234", IsDeleted = boolean, Department = "IT", WorkPlace = b, StartHour = 5, EndHour = 12, Days = "H_K_SZ_CS_P" };
                Employee e10 = new Employee { Name = "corina21", Password = "182234", IsDeleted = boolean, Department = "Admin", WorkPlace = re, StartHour = 5, EndHour = 12, Days = "H_K_SZ_CS_P" };
                ...
                Employee e12 = new Employee { Name = "annie68", Password = "1824534", IsDeleted = boolean, Department = "Student", WorkPlace = g, StartHour = 5, EndHour = 12, Days = "H_K_SZ_CS_P" };
                Employee e13 = new Employee { Name = "brian24", Password = "182834", IsDeleted = boolean, Department = "Student", WorkPlace = w, StartHour = 7, EndHour = 17, Days = "H_K_SZ_CS_P_SZO_V" };
